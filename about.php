        ...
        <div class="row align-items">
            <div class="col-md-3" data-aos="fade-up">
              <div class="box">
                ...
                <p class="fs20 fw300">Streamlining IT infrastructure and support, freeing you to focus on your core mission of educating the next generation.</p>
              </div>
            </div>
            </div>
         ...
         <div class="col-md-3" data-aos="fade-up">
           <div class="box">
              ...
              <div class="digital-content">
                ...
                <p class="fs20 fw300">Providing 24/7 access to personalized support, resources, and learning tools that enhance engagement and achievement.</p>
              </div>
            </div>
            </div>
           ...
           <div class="box">
              ...
              <div class="digital-content">
                ...
                <p class="fs20 fw300">Equipping faculty with innovative tools and resources that revolutionize teaching, streamline workflows, and maximize their impact.</p>
              </div>
            </div>
            </div>
           ...
           <div class="box">
              ...
              <div class="digital-content">
                <p class="digital-content-heading fs30">Optimizing Operations</p>
                <p class="fs20 fw300">Leveraging data insights and automation to improve efficiency, reduce costs, and make informed decisions.</p>
              </div>
            </div>
            </div>
        ...
        <div class="row align-items justify-content-center">
           ...
           <div class="box">
              ...
              <div class="digital-content">
                ...
                <p class="fs18 fw300 clr666">C0-FOUNDER & ADMIN HEAD </p>
              </div>
            </div>
            </div>
             ...
             <div class="col-md-4" data-aos="fade-up">
              ...
              <div class="digital-content">
                <p class="cinzel fs30">PRADEEP GUPTA</p>
                <p class="fs18 fw300 clr666">FOUNDER & CEO</p>
              </div>
            </div>
            </div>
        </div>
